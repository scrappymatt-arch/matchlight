const CACHE_NAME = "yorakka-v4.12";
const APP_FILES = ["./", "./index.html", "./styles.css?v=4.12", "./app.js?v=4.12", "./manifest.json", "./icon.svg", "./alert-crowd-positive.mp3", "./alert-crowd-negative.mp3", "./yorakka-banner.webp"];
