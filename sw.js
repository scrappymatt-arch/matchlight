const CACHE_NAME = "yorakka-v3.33";
const APP_FILES = ["./", "./index.html", "./styles.css?v=3.33", "./app.js?v=3.33", "./manifest.json", "./icon.svg", "./alert-crowd-positive.mp3", "./alert-crowd-negative.mp3", "./yorakka-banner.webp"];
