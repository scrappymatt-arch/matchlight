const CACHE_NAME = "yorakka-v4.09";
const APP_FILES = ["./", "./index.html", "./styles.css?v=4.09", "./app.js?v=4.09", "./manifest.json", "./icon.svg", "./alert-crowd-positive.mp3", "./alert-crowd-negative.mp3", "./yorakka-banner.webp"];
